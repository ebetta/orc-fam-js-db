...
export default function ImportHeader() {
  return (
    <Card className="bg-gradient-to-r from-teal-600 to-teal-800 border-0 shadow-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="flex items-center gap-3 bg-white/10 rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-teal-100">CSV e OFX</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 bg-white/10 rounded-lg p-4">
              ...
              <div>
                ...
                <p className="text-sm text-teal-100">Evita duplicatas</p>
              </div>
            </div>
            
            <div className="flex items-center gap-3 bg-white/10 rounded-lg p-4">
              <Upload className="w-8 h-8 text-teal-200" />
              <div>
                <h3 className="font-semibold">Atualização Automática</h3>
                <p className="text-sm text-teal-100">Saldos e categorias</p>
              </div>
            </div>
          </div>
        </div>
